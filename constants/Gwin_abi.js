			...
			outputs: [
				{
					...
					internalType: "struct GwinProtocol.Pool[]",
					name: "",
					type: "tuple[]",
				},
			],
			...
			outputs: [
				{
					components: [
						...
						{
							internalType: "uint256",
							name: "cBalancePreview",
							type: "uint256",
						},
						{
							internalType: "uint256",
							name: "hBalancePreview",
							type: "uint256",
						},
						{
							internalType: "uint256",
							name: "userCEthBalPreview",
							type: "uint256",
						},
						{
							internalType: "uint256",
							name: "userHEthBalPreview",
							type: "uint256",
						},
					],
					internalType: "struct GwinProtocol.PoolWithBalances[]",
					name: "poolsWithBalances",
					type: "tuple[]",
				},
			],
			stateMutability: "view",
