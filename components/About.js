        ...
        <div className="grid grid-cols-1 text-gray-900 pb-4">
            <div className="bg-sky-50 m-3 shadow-lg px-6 py-8 rounded-lg text-gray-700">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <h2 class="text-lg text-indigo-600 font-semibold">Gwin Finance</h2>
                    <p class="mt-2 text-3xl leading-8 font-bold tracking-tight text-gray-900 sm:text-4xl sm:tracking-tight">How to Use Gwin</p>
                    <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">With Gwin Finance, it's so simple to stake your WETH and DAI to earn GWIN.</p>
                    </div>
