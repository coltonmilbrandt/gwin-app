...
const svgIcon = (leverage) => {
	switch (getHeat(leverage)) {
		...
		case "heated":
			return (
				<div className="absolute top-2 left-2 w-12 h-12">
					<div className="flex content-center bg-orange-300 rounded-full p-1 w-10 h-10">
						<svg
							className="fill-orange-100 w-3/4 h-3/4 m-auto relative block"
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 384 512"
						>
		...
		case "shorted":
			return (
				<div className="absolute top-2 left-2 w-12 h-12">
					<div className="flex content-center bg-red-300 rounded-full p-1 w-10 h-10">
						<svg
							className="fill-red-100 w-3/4 h-3/4 m-auto relative block"
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 576 512"
						>
